...
// Scattered dot positions (% x, % y, size px)
const DOTS = [
  [8, 12, 4], [18, 28, 2.5], [5, 48, 3], [12, 68, 2], [7, 82, 4],
  [28, 8, 3], [38, 18, 2], [25, 88, 3], [35, 78, 2.5],
  [62, 8, 2], [72, 18, 4], [88, 10, 3], [92, 28, 2],
  [82, 48, 3], [94, 62, 2.5], [88, 78, 4], [78, 88, 2],
  [52, 92, 3], [45, 82, 2], [55, 12, 2.5], [48, 22, 2],
];
